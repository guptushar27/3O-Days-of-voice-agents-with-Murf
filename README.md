...
1. **Start Recording**: Click the animated voice orb to begin recording
2. **Speak Clearly**: Talk naturally into your microphone
3. **Stop Recording**: Click the orb again to stop recording
4. **AI Processing**: Watch the wave animation as your speech is processed
5. **View Response**: See the conversation in the chat interface
